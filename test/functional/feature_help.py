...
"""Verify that starting chatll with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start chatll with -h for help text")
        ...
        self.log.info("Start chatll with -version for version information")
        ...
        self.log.info("Start chatlld with -fakearg to make sure it does not start")
