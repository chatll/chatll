# Support for Output Descriptors in chatll Core

Since chatll Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `chtl1...` for mainnet or `tchtl1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
on chatll's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing chatll Core wallets, a convenience function `combo` is
