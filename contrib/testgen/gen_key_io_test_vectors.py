...
bech32_templates = [
  ...
  ('chtl',   0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('chtl',   0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('chtl',   1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('tchtl',  0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('tchtl',  0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('tchtl',  2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('rchtl',  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('rchtl',  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('rchtl', 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('tc',    0, 20, False, False, False),
  ('tchtl',  17, 32, False, False, False),
  ('rchtl',  3,  1, False, False, False),
  ('chtl',   15, 41, False, False, False),
  ('tchtl',  0, 16, False, False, False),
  ('rchtl',  0, 32, True,  False, False),
  ('chtl',   0, 16, True,  False, False),
  ('tchtl',  0, 32, False, True,  False),
  ('rchtl',  0, 20, False, False, True)
]
