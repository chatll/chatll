...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " chatll-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  chatll-tx [options] <hex-tx> [commands]  Update hex-encoded chatll transaction\n" +
            "or:     chatll-tx [options] -create [commands]   Create hex-encoded chatll transaction\n" +
            "\n";
