...
{
    const char* pszTimestamp = "Breitbart 25/Apr/2022 Elon Wins: Twitter to Be Sold to Elon Musk";
...
public:
    CMainParams() {
        ...
        // vSeeds.emplace_back("seed-a.chatll.loshan.co.uk");
        // vSeeds.emplace_back("dnsseed.thrasher.io");
        // vSeeds.emplace_back("dnsseed.chatlltools.com");
        // vSeeds.emplace_back("dnsseed.chatllpool.org");
        vSeeds.emplace_back("dnsseed.chatll.in", true);

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,28);
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,5);
        base58Prefixes[SCRIPT_ADDRESS2] = std::vector<unsigned char>(1,50);
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,28);
        base58Prefixes[EXT_PUBLIC_KEY] = {0xcb, 0x88, 0xB2, 0x1E};
        base58Prefixes[EXT_SECRET_KEY] = {0xdb, 0x88, 0xAD, 0xE4};

        bech32_hrp = "chtl";

        vFixedSeeds = std::vector<SeedSpec6>(pnSeed6_main, pnSeed6_main + ARRAYLEN(pnSeed6_main));

        fDefauchtlonsistencyChecks = false;
...
public:
    CTestNetParams() {
        ...
        // vSeeds.emplace_back("testnet-seed.chatlltools.com");
        // vSeeds.emplace_back("seed-b.chatll.loshan.co.uk");
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        fDefauchtlonsistencyChecks = true;
        fRequireStandard = false;
