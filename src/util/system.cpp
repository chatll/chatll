...
const char * const BITCOIN_CONF_FILENAME = "chatll.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "chatll";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/chatll";
#else
    // Unix
    return pathRet / ".chatll";
#endif
#endif
}
